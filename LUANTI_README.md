...
Antilua is a free open-source voxel game engine with easy modding and game creation,
based on the Luanti engine.
...
- Default location:
    `user/minetest.conf`
- This file is created by closing Antilua for the first time.
