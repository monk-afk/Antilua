...
core.register_on_mods_loaded(function()
	...
	test_antilua_wasplib(df_test)
	test_antilua_lockview(df_test)
	test_antilua_headsaver(df_test)
	test_antilua_invsaver(df_test)
	test_antilua_walls(df_test)
	test_antilua_autoevade(df_test)
	test_antilua_extracted_features(df_test)
