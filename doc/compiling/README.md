...
General options and their default values:
    ...
    BUILD_CLIENT=TRUE          - Build Antilua client
    BUILD_SERVER=FALSE         - Build Antilua server
    ...
    INSTALL_DEVTEST=FALSE      - Whether the Development Test game should be installed alongside Antilua
    ...
    VERSION_EXTRA=             - Text to append to version (e.g. VERSION_EXTRA=foobar -> Antilua 5.10.0-foobar)
