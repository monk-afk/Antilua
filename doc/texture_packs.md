Antilua Texture Pack Reference
===============================
...
* `name`: The texture pack name. Allows Antilua to determine the texture pack name even if
...
the apple texture of Antilua Game, add a PNG file named `default_apple.png`.
...
* `moon.png`: texture of the moon. Default texture is generated by Antilua
* `moon_tonemap.png`: tonemap to be used when `moon.png` was found
* `sun.png`: texture of the sun. Default texture is generated by Antilua
...
Antilua has three modes for rendering leaves nodes if the node has the
