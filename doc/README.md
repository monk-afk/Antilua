...
This directory contains mostly reference documentation for the Antilua engine.
...
- [texture_packs.md](texture_packs.md): Layout and description of Antilua's
...
- [world_format.md](world_format.md): Structure of Antilua world directories and
...
- [protocol.txt](protocol.txt): *Rough* outline of Antilua's network protocol.
...
- [developing/](developing/): Information about Antilua development.
...
- [direction.md](direction.md): Information related to the future direction of
    Antilua. Commonly referred to as the roadmap document.
