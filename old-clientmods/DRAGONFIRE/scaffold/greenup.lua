...
ws.rg("PlaceOn", { category = "Placers", setting = "placeon",
	on_step = function(self)
		...
		local poss = minetest.find_nodes_near_under_air_except(pos, range, {node})
...
ws.rg("TorchUp", { category = "Placers", setting = "torchup",
	on_step = function(self)
		local range = tonumber(core.settings:get(self.setting .. ".range")) or 4
