...
incremental_tp.fudge = 1.1 -- cause the tp time isn't synced with the server
...
poi.register_transport('itp',function(pos,name) incremental_tp.tp(pos,1) end)

poi.register_transport('jitp',function(pos,name) incremental_tp.tp(pos,0.5,0.4) end)
