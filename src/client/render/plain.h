...
private:
	...
	void drawEntityESP(PipelineContext &context, const v3f &camera_pos, const v3f &camera_offset);
	void drawPlayerESP(PipelineContext &context, const v3f &camera_pos, const v3f &camera_offset);
};
